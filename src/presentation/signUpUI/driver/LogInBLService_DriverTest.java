...
public class LogInBLService_DriverTest {
	...
	public void test1() {
		...
		assertEquals(driver.logInBLService.guestSignUp(new GuestVO("1234567890", LocalDate.of(1995, 4, 1), 
				"school","zhangsan", "xiaosan", "000000", "13568792345", 100)), ResultMessage.SUCCESS);
	}
}
